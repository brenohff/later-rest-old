package br.com.brenohff.later.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("br.com.brenohff.later.api"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("Later API",
                "API para controle do aplicativo Later",
                "Versão 1.0.0",
                "",
                new Contact("Breno Henrique", "https://www.github.com/brenohff", "brenohff@gmail.com"),
                "",
                "",
